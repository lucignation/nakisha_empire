...
export default async function AdminInventoryDetailPage(props: { params: { id: string } }) {
  requireAdminSession();
  const product = await getAdminProductById(props.params.id);
  ...
  return (
    <div className="min-h-screen bg-[#0b1020] p-5 lg:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <AdminInventoryManager product={product} />
      </div>
    </div>
  );
}
